        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Markdown = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogRelatePostTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogRelatePostTag_BlogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogRelatePostTag_BlogTags_TagId",
                        column: x => x.TagId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogRelatePostTag_PostId",
                table: "BlogRelatePostTag",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogRelatePostTag_TagId",
                table: "BlogRelatePostTag",
                column: "TagId");
