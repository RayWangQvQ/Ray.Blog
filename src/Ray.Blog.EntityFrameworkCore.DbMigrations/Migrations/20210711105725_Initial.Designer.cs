...
namespace Ray.Blog.Migrations
{
    ...
    [Migration("20210711105725_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ray.Blog.Blog.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ray.Blog.Blog.FriendLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BlogFriendLinks");
                });

            modelBuilder.Entity("Ray.Blog.Blog.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Blog.RelatePostTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BlogRelatePostTag");
                });

            modelBuilder.Entity("Ray.Blog.Blog.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Hots.Data", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Hots.Hot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Messages.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Sayings.Saying", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BlogSayings");
                });

            modelBuilder.Entity("Ray.Blog.Signatures.Signature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Ray.Blog.Blog.Post", b =>
                {
                    b.HasOne("Ray.Blog.Blog.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Ray.Blog.Blog.RelatePostTag", b =>
                {
                    b.HasOne("Ray.Blog.Blog.Post", "Post")
                        .WithMany("RelatePostTags")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ray.Blog.Blog.Tag", "Tag")
                        .WithMany("RelatePostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ray.Blog.Hots.Data", b =>
                {
                    b.HasOne("Ray.Blog.Hots.Hot", null)
                        .WithMany("Datas")
                        .HasForeignKey("HotId");
                });
